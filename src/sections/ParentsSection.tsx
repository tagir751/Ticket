...
export default function ParentsSection() {
  ...
  const paragraphs = [
    ...
    'Вы увидите, как ребёнок перестаёт «шариться» по улицам и начинает думать. Как у него появляются вопросы, а не только «скучно». Как он учится формулировать мысли, отстаивать точку зрения, планировать шаги.',
