...
export default function ProblemSection() {
  ...
  const paragraphs = [
    ...
    'Через год эту кнопку нажимать будет каждый второй. А ты — снова в очереди за «местом у окна».',
  ];
          ...
          >
            <div className="relative p-8 lg:p-10 bg-dark-card rounded-2xl border-l-4 border-orange">
              ...
              <p className="text-xl lg:text-2xl font-semibold text-orange leading-relaxed">
                Навык — это не знать кнопку. 
                <br />
                <br />
                Навык — это уметь думать так, чтобы кнопка делала то, что нужно тебе.
              </p>
            </div>
          </motion.div>
        </div>
